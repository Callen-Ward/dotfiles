...
if [ "$TMUX" = "" ]; then tmux attach -t default || tmux new-session -s default; fi

# define ls_colors so completion can use them
...
# use vim keys to move through autocomplete list
